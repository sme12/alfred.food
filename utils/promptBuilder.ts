  ...
  "shoppingTrips": [
    {
      ...
      "items": [
        { "name": "Яйца", "amount": "10 шт", "category": "dairy", "forMeal": "Пн — Завтрак: Омлет, Ср — Ужин: Запеканка" },
        { "name": "Куриное филе", "amount": "600 г", "category": "meat", "forMeal": "Вт — Обед: Курица с овощами" },
        ...
      ]
    },
    {
...
- Для каждого продукта укажи forMeal (если несколько блюд — через запятую): "Пн — Завтрак: Омлет, Ср — Ужин: Запеканка"`);
